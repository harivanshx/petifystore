      ...
      <div className="min-h-screen bg-gradient-to-r from-teal-400 to-cyan-600 flex items-center justify-center">
        <div className="text-center text-white p-8 max-w-3xl">
          ...
          <p className="text-xl mb-8">
            Your one-stop platform to find, adopt, and care for your furry
            friends. Join us in making every pet's life happier and healthier.
          </p>
          ...
          <div className="mt-12">
            <img
              src="src\assets\Product Images\Featured\Dogfood.jpg"
              alt="Cute Pets"
